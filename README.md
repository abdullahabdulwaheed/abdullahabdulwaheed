...
---
# 🚀 Featured Projects ## 🌍 Portfolio Website
Modern personal portfolio showcasing projects, skills, and
experience.
**Tech Stack**
`HTML` `CSS` `JavaScript` `React`
🔗 Live Demo: https://abdullah-portfolio-7iqn.onrender.com/
📂 Repository: [[GitHub Repository]](https://github.com/abdullahabdulwaheed)
---
## 🛒 E-Commerce Website
...
authentication.
**Tech Stack**
`React` `Firebase` `Tailwind CSS` 🔗 Live Demo: [Project URL]
📂 Repository: [GitHub Repository] ---
# 📊 GitHub Stats
<p align="center">
...
- ✅ Master Full Stack Development - ✅ Learn Cloud Computing
